        ...
        <Box display="flex" flexDirection={{ xs: 'column', md: 'row' }} alignItems="center" mb={{ xs: 6, md: 5 }}>
          ...
          <GridContainer>
            <Grid item xs={12} sm={6}>
              <AppTextInput fullWidth variant="outlined" label="First name" />
            </Grid>
            <Grid item xs={12} sm={6}>
              <AppTextInput fullWidth variant="outlined" label="Last name" />
            </Grid>
            <Grid item xs={12} sm={6}>
              <AppTextInput fullWidth variant="outlined" label="Gender" />
            </Grid>
            <Grid item xs={12} sm={6}>
              <AppTextInput fullWidth variant="outlined" label="Birth Year" />
            </Grid>
          </GridContainer>
        </Box>
        <Box mb={{ xs: 6, md: 5 }}>
          <GridContainer>
            <Grid item xs={12} sm={12}>
              <AppTextInput fullWidth variant="outlined" label="Home Address" />
            </Grid>
            {/* <Grid item xs={12} sm={6}>
              <AppTextInput
                fullWidth
            ...
            <Grid item xs={12} sm={6}>
              <AppTextInput fullWidth variant="outlined" label="Phone" />
            </Grid>
            <Grid item xs={12} sm={6}>
              <AppTextInput fullWidth variant="outlined" label="Email Address" />
            </Grid>
          </GridContainer>
        </Box>
        <br />
