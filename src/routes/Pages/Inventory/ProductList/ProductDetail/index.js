...
const ProductDetail = ({ open, handleDialog }) => {
  ...
  return (
    <Dialog open={open} onClose={handleDialog} className={classes.dialogRoot}>
      ...
      <Box px={6} py={5}>
            <Box mb={3} color="common.dark" component="p" pl={60}>
              Product Detail
            </Box>
        
          <Box display="flex" alignItems="center" mb={1} color="primary" pl={5}>
            <Typography color="red" fontWeight="900"> Description: </Typography>
            <Typography color="primary" pl={20} >{currentProduct.description}</Typography>
          </Box>
