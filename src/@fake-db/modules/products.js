...
export const foldersList = [
  { id: 1, name: 'All Items', slug: 'products', icon: <ListIcon /> },
  { id: 2, name: 'Available stocks', slug: 'available', icon: <EventAvailableIcon /> },
  { id: 3, name: 'Out of stocks', slug: 'unavailable', icon: <RemoveShoppingCartIcon /> },
...
export const popularFoldersList = [
  { id: 1, name: 'Product List', slug: 'products', icon: <StoreMallDirectoryIcon /> },
  { id: 3, name: 'Out of stocks', slug: 'unavailable', icon: <RemoveShoppingCartIcon /> },
  { id: 4, name: 'Starred Items', slug: 'starred', icon: <StarIcon /> },
  // {id: 5, name: "Trash", slug: "trash", icon: <DeleteIcon />}
];
